 ...
 <div className=" fade-in-left flex items-end justify-start fixed bottom-0 left-0 ml-4 z-10">
    <div> 
      <ul className='flex items-center  -mb-5'>
        ...
        <null className='fade-in-left delay-100 cursor-default text-white italic text-xs pb-2'>Designed & Developed by <Link href="https://cyberspacedigital.in/"> Cyber Space Digital</Link></null>
    </div>
  </div>
</footer>
  )
