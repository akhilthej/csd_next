...
export const WebDevelopmentCompany = {
  ...
  subtitle:
    "Cyber Space Digital is your trusted partner for innovative and scalable web development solutions.",
  coverImage: {
  ...
  section2: {
    tagline: "Web Development that Powers Your Business.",
    heading: "Bring Your Ideas to Life Online.",
    description:
...
export const MobileAppDevelopment = {
  ...
  section2: {
    tagline: "Websites as your Business Need.",
    heading: "Build Your Web Office Online.",
    description:
