...
import aboutcover from './images/about.webp'
import CEO from './images/Founder.webp'
import CTO from './images/CTO.webp'
import COO from './images/COO.webp'
import Chaitanya from './images/chaitanya.webp'
import SaiKiran from './images/saikiran.webp'
import Srikar from './images/srikar.webp'
import Varun from './images/varun.webp'
    ...
    <div className="grid gap-12 items-center md:grid-cols-3">
      <div className="space-y-4 text-center">
        ...
        <div>
          ...
          <span className="block text-sm text-gray-200">Partner<br/>Chief Operations Officer</span>
        </div>
      </div>
      <div className="space-y-4 text-center">
        <Image
  ...
  <div className="container px-6 py-10 mx-auto">
    ...
    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
      <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-yellow-600 rounded-xl">
        ...
        <p className="mt-2  capitalize text-gray-200 group-hover:text-gray-200">
        ...
        <div className="flex mt-3 -mx-2">
          <a
            href="#"
            className="mx-2 text-gray-200 hover:text-gray-200 group-hover:text-white"
            aria-label="Reddit"
          >
            <svg
