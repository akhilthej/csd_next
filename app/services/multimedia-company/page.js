...
import { MultiMediaCompany } from "../../../public/PageData"; // Adjust the path as necessary
    ...
    <div className="services">
      ...
      <main>
        ...
        <section
          ...
          style={{
            backgroundImage: `url("${MultiMediaCompany.coverImage.src}")`,
            backgroundSize:
              MultiMediaCompany.coverImage.style.backgroundSize,
            backgroundPosition:
...
export default multiMediaCompany;
