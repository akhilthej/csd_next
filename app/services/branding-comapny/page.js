...
import { BrandingCompany } from "../../../public/PageData"; // Adjust the path as necessary
    ...
    <div className="services">
      ...
      <main>
        ...
        <section
          ...
          style={{
            backgroundImage: `url("${BrandingCompany.coverImage.src}")`,
            backgroundSize:
              BrandingCompany.coverImage.style.backgroundSize,
            backgroundPosition:
