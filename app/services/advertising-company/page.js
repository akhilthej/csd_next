...
import { AdvertisingCompany } from "../../../public/PageData"; // Adjust the path as necessary
    ...
    <div className="services">
      ...
      <main>
        ...
        <section
          ...
          style={{
            backgroundImage: `url("${AdvertisingCompany.coverImage.src}")`,
            backgroundSize:
              AdvertisingCompany.coverImage.style.backgroundSize,
            backgroundPosition:
